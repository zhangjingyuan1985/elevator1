 ...
 * @Version
 */
object odsEvtFatriFault {

  def main(args: Array[String]): Unit = {

    val mysqlTableName = "fatri_fault"
    val namespace = "ods"
    val tableName = "S002_EVT_FATRI_FAULT"
    val columnFamily = "info"
    val consumerTopic = "example,example4"
    val topic = "ODS-S002-DEV-FATRI-FAULT"
    val rowKeyField = "OrderId"
    val jobName = "ODS-S002-DEV-FATRI-FAULT"
