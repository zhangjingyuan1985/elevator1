 ...
 * @Version
 */
object odsDevFatriDevice {

  def main(args: Array[String]): Unit = {

    val mysqlTableName = "fatri_device"
    val namespace = "ods"
    val tableName = "S002_DEV_FATRI_DEVICE"
    val columnFamily = "info"
    val consumerTopic = "example,example4"
    val producerTopic = "ODS-S002-DEV-FATRI-DEVICE"
    val rowKeyField = "DeviceId"
    val jobName = "ODS-S002-DEV-FATRI-DEVICE"
